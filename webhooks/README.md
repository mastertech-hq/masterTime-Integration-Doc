...
จากนั้นระบบ masterTime จะส่ง Confirmation Event ไปหา Webhook Receiver Endpoint ทุก 3 นาที
...
ระหว่าง [การหยุดส่ง Event และการ Disable Subscription ถาวร](#การหยุดส่ง-event-และการ-disable-subscription-ถาวร)
ระบบ masterTime จะส่ง Confirmation Event ไปหา Webhook Receiver Endpoint ทุก 3 นาที
เพื่อตรวจสอบว่า Webhook Receiver Endpoint ดังกล่าวสามารถกลับมาทำงานได้เป็นปกติแล้วหรือไม่

ถ้า Webhook Receiver Endpoint ไม่สามารถตอบกลับ Confirmation Event ได้อย่างถูกต้องภายในเวลา 30 วัน
การ Subscription นั้นจะถูกยกเลิกอย่างถาวร และ Event ที่เกี่ยวข้อง ที่ไม่สามารถส่งได้ภายในเวลา 30 ที่ผ่านมา
...
และต้องส่ง `"challenge_value"` ที่ได้รับ กลับมาใน Response body ด้วย ดังนี้
