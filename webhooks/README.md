...
Event ที่เกี่ยวข้อง ที่ไม่สามารถส่งได้ภายในเวลา 30 ที่ผ่านมา
...
จะต้องตอบ HTTP Response Code `200 OK` (⚠️ **แตกต่างกับการตอบกลับตามปกติที่จะตอบ `202 Accepted`** ⚠️) กลับมาภายใน 10 วินาที
จึงจะถือว่าการตอบนั้นสำเร็จ
