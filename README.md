...
โดยการเรียก API ทุกครั้ง Client ต้องแนบ `access_token` ใน `HTTP Authorization` header โดยใช้เป็น `bearer token` มาด้วยทุกครั้ง (ดู [การเรียกใช้ API ด้วย Access Token](#การเรียกใช้-api-ด้วย-access-token))
